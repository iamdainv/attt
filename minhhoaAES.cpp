...
int main()
{
	...
	// CDAB0FC51CACBCF9A8A348C3D2D0247A
  // unsigned int w0 = 0xAADE12F3, w1 = 0x9F579A5A, w2 = 0x49845A77, w3 = 0x97FE9146;
  //k=344E7412 9CD8D1D1 27FC62A0 1EF147B7
   unsigned int w0 = 0xCDAB0FC5, w1 = 0x1CACBCF9, w2 = 0xA8A348C3, w3 = 0xD2D0247A;
   unsigned int Key[] = {w0, w1, w2, w3};
	//input  M = BC3034B5D3677672E290C28DC16922FB
	//M = 18DC9095 F9149EDB 7323F20E 4E462D92
	//M = B104AADD 3AC293DF 787EFD2C F8065925 AB5BFF34115C963B835CAF027EBE0B53
	//m= 58A89BB7 073DAA06 0FF43675 1C46674C
    unsigned int *state = new unsigned[4];
	//state[0] = 0xBC3034B5; state[1] = 0xD3677672; state[2] = 0xE290C28D; state[3] = 0xC16922FB;
	state[0] = 0xAB5BFF34; state[1] = 0x115C963B; state[2] = 0x835CAF02; state[3] = 0x7EBE0B53;
	//Bat dau	 test
